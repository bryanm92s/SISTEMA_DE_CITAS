...
class Profesiones extends CI_Controller {
	...
	public function index()
	{
		...
		$vector["pagina"]="Listado de Profesiones";
		...
		$crud->set_table('tblprofesiones');
		$crud->set_subject('Listado de Profesiones');
		// para colocarle el nombre de columna que deseemos usamos display_as
		$crud->display_as("nombre_profesion","Nombre Profesion");
		...
		$crud->required_fields("nombre_profesion");
		...
		$crud->add_fields("nombre_profesion");
		$crud->edit_fields("nombre_profesion");
		...
		$this->load->view('profesiones',$vector);
	}
}